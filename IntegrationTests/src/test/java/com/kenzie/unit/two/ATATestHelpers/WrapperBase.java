...
public abstract class WrapperBase {
    ...
    protected static Object invokeInstanceMethodWithReturnValue(
        ...
        try {
            ...
            AtaTestHelper.failTestWithException(e, String.format("Unable to access %s on %s",
                    method.getName(),
                    invokeTarget.getClass().getSimpleName()));
        } catch (InvocationTargetException e) {
            AtaTestHelper.failTestWithException(e.getCause(), String.format("Failed to successfully call %s on %s",
                    method.getName(),
                    invokeTarget.getClass().getSimpleName()));
        }
